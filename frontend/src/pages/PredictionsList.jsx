              ...
              {predictions.map((p) => (
                <tr key={p._id}>
                  <td style={{ fontWeight: 600 }}>
                    {p.customer?.name || "Deleted customer"}
                  </td>
